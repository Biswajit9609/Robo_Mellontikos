...
const Contact = () => {
  // NEW: Replaced text icons with JSX SVG elements
  ...
  // MODIFIED: 'email' property is now 'contact' and contains the phone number
  const departments = [
        ...
        <div className="container-max mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {socialChannels.map((item) => (
              <a key={item.title} href={item.link} target="_blank" rel="noopener noreferrer" className="hud-card p-6 text-center border-secondary group">
                <div className="text-primary mb-4 transition-transform duration-300 group-hover:scale-110">
                  {item.icon} {/* Renders the SVG icon */}
                </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-6">
              {departments.map((dept) => {
                // Extracts the phone number for the tel: link
